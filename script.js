/* ============================================================
   MANOJ KUMAR B N — Portfolio Script
...
contactForm?.addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const mailto = `mailto:manojkumarmanu32100@gmail.com?subject=${encodeURIComponent(subject || 'Portfolio Inquiry')}&body=${encodeURIComponent(`From: ${name} <${email}>\n\n${message}`)}`;
